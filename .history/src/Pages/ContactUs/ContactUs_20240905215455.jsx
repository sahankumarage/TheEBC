  ...
  return (
    <>
      <Grid container mt={10}>
        ...
        <Grid item xs={12} sx={{ mt:{xs:5, sm:0}}} sm={6} spacing={5} p={3}>
          <Typography
            color="black"
            variant="h3"
            sx={{
          ...
          >
            We're here to help with any questions or inquiries you may have. Whether you're interested in learning more about our courses, need assistance with enrollment, or have specific requirements, don't hesitate to reach out. Our team is dedicated to providing you with the support and information you need. We look forward to hearing from you!
          </Typography>
