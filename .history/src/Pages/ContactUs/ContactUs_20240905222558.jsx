...
import GoogleFormEmbed from "../../Components/StudentsEnroll/GoogleForm";
...
function ContactUs() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const scriptURL = 'https://script.google.com/macros/s/AKfycbzFTGKH7B5H6b2iXChVHhroSGoaXvfU34Cijo9FweEiyKB6_Xh0oav7hEGGB9zwEKxb/exec';

    // Create a new script element
    const script = document.createElement('script');
    const callback = 'jsonpCallback_' + Date.now();

    // Create the URL with form data and callback
    ...
    // Set the src and append to document
  ...
  return (
    <>
      <Grid container mt={10}>
        ...
        >
          <Typography
            ...
            sx={{
              ...
              "&::after": {
                content: '""',
                position: "absolute",
                left: { lg: "-40px", md: "-65px", sm: "-50px", xs: "-15px" },
                bottom: "-10px",
                width: "50%",
                height: "20px",
          ...
          >
            ...
            Whether you're interested in learning more about our courses, need
            assistance with enrollment, or have specific requirements, don't
            hesitate to reach out. Our team is dedicated to providing you with
            the support and information you need. We look forward to hearing
            from you!
          </Typography>
      ...
      <Grid container mt={6} display="flex" justifyContent="center" p={3}>
      ...
      {/* <Grid container mt={10} sm={12} display="flex" justifyContent="center">
