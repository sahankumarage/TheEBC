        ...
        <Grid item xs={10} sm={6} spacing={5}>
          ...
          <Grid container mt={5}>
            <Grid item xs={4} sm={2} display='flex' justifyContent='center'>
              ...
              >
                <FacebookIcon sx={{ fontSize: 80, color: '#0C44AE' }} />
              </IconButton>
            </Grid>
            ...
            <Grid item xs={3} sm={2}  display='flex' justifyContent='center'>
              ...
              >
                <YoutubeIcon sx={{ fontSize: 40, color: '#0C44AE' }}  />
              </IconButton>
            </Grid>
            <Grid item xs={3} sm={2}  display='flex' justifyContent='center'>
              <IconButton
              ...
              >
                <InstagramIcon sx={{ fontSize: 40, color: '#0C44AE' }}  />
              </IconButton>
            </Grid>
            <Grid item xs={3} sm={2}  display='flex' justifyContent='center'>
              <IconButton
              ...
              >
                <TikTokIcon sx={{ fontSize: 40, color: '#0C44AE' }}  />
              </IconButton>
            </Grid>
          </Grid>
        </Grid>
