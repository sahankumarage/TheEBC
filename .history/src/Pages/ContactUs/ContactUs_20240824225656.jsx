...
function ContactUs() {
  return (
    <>
      <Grid container mt={10} spacing={5}>  {/* Added spacing here */}
        <Grid item xs={12} md={6}>  {/* Updated to handle responsive layout */}
          <Box display="flex" justifyContent="center">
            <Map />
          </Box>
        </Grid>
        <Grid item xs={12} md={6}>  {/* Updated to handle responsive layout */}
          <Box position="relative">  {/* Position relative for pseudo-element */}
            <Typography
              color="black"
              variant="h3"
              sx={{
