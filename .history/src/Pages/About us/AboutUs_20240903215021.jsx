      ...
      <Container maxWidth="xl">
        ...
        >
          ...
          >
            ...
            At our institute, we believe that English is essential for Sri Lankan students to achieve their goals and unlock their full potential. Despite English being taught from grades 1 to 13 in Sri Lanka, many students struggle with fear and a lack of passion for the language, which hinders their progress. Recognizing the importance of English as a global language, we’ve developed an innovative approach that truly engages students. We constantly experiment with new methods to help them improve, particularly focusing on students from underprivileged backgrounds. Our collaboration with foreign instructors in Colombo has been especially impactful, bringing us great joy as we witness the positive changes in our students' lives. Our commitment is to always support and enhance English education for Sri Lankan students.
            </Typography>
          </Grid>
        </Grid>
        <Box mt={12}>
