  ...
  return (
    <>
      ...
      <Container  maxWidth="xl" sx={{
        ...
        <Grid container>
          <Grid item xs={12} textAlign='start' justifyContent='start' display='flex'>
            <Typography
              color="black"
              variant='h2'
              sx={{fontWeight:"600"}}
          ...
          <Grid item xs={6} textAlign='start' justifyContent='start' display='flex'>
            <Typography
              color="black"
              variant='h5'
              sx={{fontWeight:"600", padding:"10px"}}
            >
             Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem maiores ipsa nobis nam nemo saepe delectus, voluptates laudantium cum, assumenda porro? Saepe tempore sint animi. Distinctio quidem dignissimos fuga libero.
            </Typography>
          </Grid>
        </Grid>
      </Container>
