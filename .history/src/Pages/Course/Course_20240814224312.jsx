    ...
    <>
      ...
      <Box>
        <Container maxWidth="xl">
                ...
                <Box>
                  <Button
                    ...
                    sx={{
                      ...
                      padding: "12px 56px", // Increase padding for size
                      fontSize: "1.0rem",
                      "&:hover": {
          ...
          <Box mt={2}>
            <Grid container>
              <Grid xs={12} p={3} item display="flex" justifyContent="start">
                <Box>
                  <Typography variant="h4">Entry requirements</Typography>
                  <Typography variant="h5">Lorem Ipsum is simply dummy text of the printing AAtypesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown
                  standard dummy text ever since the 1500s, when an unknown standard dummy text ever since the 1500s, when an unknown </Typography>
