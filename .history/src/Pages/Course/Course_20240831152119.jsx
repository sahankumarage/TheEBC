          ...
          <Box mt={12}>
            <Grid container gap={5} display="flex" justifyContent="center">
              <Grid xs={10} sm={12} item>
                <CourseDetails img={Image3} title={"1. Confident Communication with Native Instructors"} details={"Learn to think and speak like native English speakers. Experience the highlights of mastering English easily and effectively."} />
              </Grid>
              <Grid xs={10} sm={12} item>
