            ...
            <Grid container gap={5} display="flex" justifyContent="center">
              <Grid xs={10} sm={12} item>
                <CourseDetails
                  ...
                  details={
                    "Learn to think and speak like native English speakers. Experience the highlights of mastering English easily and effectively."
                  }
                />
              </Grid>
              <Grid xs={10} sm={12} item>
                <CourseDetails
                  ...
                  details={
                    "Engage in daily 15-minute interviews with native instructors. This crucial practice will prepare you to ace any interview after just 3 months."
                  }
                />
              </Grid>
              <Grid xs={10} sm={12} item>
                <CourseDetails
                  ...
                  details={
                    "Practice using English confidently in everyday environments, both indoors and outdoors, to make it a natural part of your daily life."
                  }
                />
              </Grid>
              <Grid xs={10} sm={12} item>
                <CourseDetails
                  ...
                  details={
                    "Master English using modern technology and entertainment sources like AI, crucial for navigating today’s digital world."
                  }
                />
              </Grid>
              <Grid xs={10} sm={12} item>
                <CourseDetails
                  ...
                  details={
                    "Participate in weekly full-day workshops with native speakers, engaging in fun activities and games to enhance your English skills."
                  }
                />
              </Grid>
              <Grid xs={10} sm={12} item>
                <CourseDetails
                  ...
                  details={
                    "Explore other cultures and countries, learn to engage with different people, and discover international opportunities."
                  }
                />
              </Grid>
              <Grid xs={10} sm={12} item>
                <CourseDetails
                  ...
                  details={
                    "Open doors to international opportunities by learning how to connect with global universities and communities."
                  }
                />
              </Grid>
            </Grid>
