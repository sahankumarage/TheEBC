              ...
              <Grid xs={12} p={3} item display="flex" justifyContent="center">
                <Box>
                  <Button
                    variant="outlined"
                    sx={{
                      color: .palette.primary.dark, // Text color
                      borderColor: theme.palette.primary.dark, // Border color
                      "&:hover": {
                        borderColor: theme.palette.primary.main, // Border color on hover
                        backgroundColor: theme.palette.primary.dark, // Background on hover
