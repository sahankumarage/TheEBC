          ...
          >
            ...
            >
              <Typography
                ...
                sx={{ fontWeight: "600" }}
              >
                Our English course is designed to help Sri Lankan students develop their English skills in a unique and effective way. This program focuses on achieving native-like fluency, thinking directly in English, and learning through practical, engaging methods.

Spanning 3-4 months, the course provides over 100 hours of immersive English practice. This extensive time frame ensures that you receive thorough language exposure and significant improvement in your English abilities.

Throughout the course, you’ll participate in interactive outdoor activities with native English instructors. These activities are designed to make learning enjoyable while helping you practice English in real-world contexts, improve your accent, and master effective learning techniques.

In addition to enhancing your language skills, the course aims to help you build global connections and explore international opportunities. By engaging with foreign instructors and participating in practical experiences, you’ll be well-prepared for future success and new opportunities.
          ...
          <Grid container mt={4} spacing={0}>
            <Grid xs={6} sm={3} item>
              <Box
                ...
                borderRadius={2}
              >
                <CourseCard img={Entry} title={"Duration"} details={"3-4 Months"} />
              </Box>
            </Grid>
            <Grid xs={6} sm={3} item>
              <Box
                ...
                borderRadius={2}
              >
                <CourseCard img={duration} title={"Entry"} details={"October / January"} />
              </Box>
            </Grid>
            <Grid xs={6} sm={3} item>
              <Box
                ...
                borderRadius={2}
              >
                <CourseCard img={location} title={"Location"} details={"Colombo(Physical)"} />
              </Box>
            </Grid>
            <Grid xs={6} sm={3} item>
              <Box
                ...
                borderRadius={2}
              >
                <CourseCard img={calender} title={"Days"} details={"Saturday / Tuesday"} />
              </Box>
            </Grid>
          </Grid>
          <Box mt={6}>
